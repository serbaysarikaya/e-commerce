...
public static class SeedDatabase
{
    ...
    public static async void Initialize(IApplicationBuilder app)
    {
        ...
        {
            var customer = new AppUser { Name = "Fatma Sarıkaya", UserName = "fatmasarikaya", Email = "fatmasarikaya@gmail.com" };
            var admin = new AppUser { Name = "Serbay Sarıkaya", UserName = "serbaysarikaya", Email = "serbaysarikay@gmail.com" };
